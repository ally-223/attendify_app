...
import { doSignInWithEmailAndPassword, doSignInWithMicrosoft } from '../auth'
                ...
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl bg-white">
                    ...
                    >
                        ...
                        <button
                            ...
                            className={`w-full px-4 py-2 text-white font-medium rounded-lg ${isSigningIn ? 'bg-gray-300 cursor-not-allowed' : 'bg-sky-600 hover:bg-sky-700 hover:shadow-xl transition duration-300'}`}
                        >
